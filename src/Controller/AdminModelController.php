...
class AdminModelController extends AbstractController
{
    ...
    {
        return $this->render('admin_model/index.html.twig', [
    ...
    public function new(Request $request, ModelRepository $modelRepository): Response
    {
        ...
        return $this->renderForm('admin_model/new.html.twig', [
            'model' => $model,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_model/show.html.twig', [
            'model' => $model,
        ]);
    }
    ...
    public function edit(Request $request, Model $model, ModelRepository $modelRepository): Response
    {
        ...
        return $this->renderForm('admin_model/edit.html.twig', [
            'model' => $model,
            'form' => $form,
        ]);
    }
