...
class LocationController extends AbstractController
{
    ...
    /**
     * @Route("/new/{id}", name="app_location_new", methods={"GET", "POST"})
     */
    public function new(Vehicule $vehicule,Request $request, LocationRepository $locationRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $vehicule->setDisponible(0);
            $location->setRendu(0);
            
            // dd($location);
            $locationRepository->add($location, true);

            $this->addFlash("success", "Votre reservation à bien été prise en compte");
