...
// pour passer un propriétet qui ne pas null a null il faut juste rajouter sur l'annotation ORM (nullable=true) et metter un point de ? sur le setter
...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setHasrent($hasrent): self
    {
    ...
    public function getRegistrateAt(): ?\DateTimeImmutable
    {
        return $this->registrateAt;
    }

    public function setRegistrateAt(\DateTimeImmutable $registrateAt): self
    {
        $this->registrateAt = $registrateAt;
